  ...
  return (
    <div className="bg-[#FAF8F5] min-h-[85vh] flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24 text-neutral-900">
      <div className="w-full max-w-2xl text-center">
        ...
        {/* DESCRIPTION */}
        <p className="text-xs sm:text-sm font-light text-neutral-600 max-w-lg mx-auto leading-relaxed">
          Thank you for choosing our collection. Your order has been successfully registered and is now being prepared with care.
        </p>

        {/* ORDER NUMBER */}
        {orderId && (
          <div className="inline-flex flex-col items-center mt-7 px-7 py-4 bg-white border border-neutral-200 shadow-sm rounded-2xl">
            <span className="text-[10px] uppercase tracking-wider text-neutral-400 font-bold mb-1">
              Order Reference
            </span>
            <span className="font-mono text-lg font-bold text-neutral-900">
              #{orderId}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-10 max-w-xl mx-auto">
          <div className="bg-white border border-neutral-200/80 p-5 rounded-2xl shadow-sm">
            <Package size={18} className="mx-auto mb-2 text-neutral-700" strokeWidth={1.5} />
            <p className="text-xs uppercase tracking-wider font-bold text-neutral-900">
              Confirmed
            </p>
          ...
          <div className="bg-white border border-neutral-200/80 p-5 rounded-2xl shadow-sm">
            <Truck size={18} className="mx-auto mb-2 text-neutral-700" strokeWidth={1.5} />
            <p className="text-xs uppercase tracking-wider font-bold text-neutral-900">
              Fast Delivery
            </p>
            <p className="text-[10px] text-neutral-500 mt-0.5">
          ...
          <div className="bg-white border border-neutral-200/80 p-5 rounded-2xl shadow-sm">
            <ShieldCheck size={18} className="mx-auto mb-2 text-neutral-700" strokeWidth={1.5} />
            <p className="text-xs uppercase tracking-wider font-bold text-neutral-900">
              Secure
            </p>
            <p className="text-[10px] text-neutral-500 mt-0.5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mt-10">
          <button
            onClick={() => navigate('/my-orders')}
            className="bg-white border border-neutral-300 text-neutral-900 px-7 py-4 text-xs font-bold uppercase tracking-wider hover:border-neutral-900 transition shadow-sm flex items-center justify-center gap-2 rounded-xl"
          >
            <Package size={15} />
            View My Orders
          </button>
          ...
          <button
            onClick={() => navigate('/shop')}
            className="bg-neutral-900 text-white px-7 py-4 text-xs font-bold uppercase tracking-wider hover:bg-black transition shadow-md flex items-center justify-center gap-2 rounded-xl group"
          >
            <ShoppingBag size={15} />
            Continue Shopping
