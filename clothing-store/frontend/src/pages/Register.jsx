  ...
  return (
    <div className="bg-[#FAF8F5] min-h-[85vh] flex items-center justify-center px-4 py-12 sm:py-16">
      <div className="w-full max-w-md">
        ...
        >
          {error && (
            <div className="mb-6 border border-red-200 bg-red-50 text-red-700 px-4 py-3 text-xs leading-relaxed rounded-xl">
              {error}
            </div>
          )}
          ...
          {/* Username */}
          <div className="mb-5">
            <label className="block text-xs uppercase tracking-wider text-neutral-700 mb-2 font-bold">
              Username
            </label>
            <input
              type="text"
              ...
              autoComplete="username"
              placeholder="Choose a username"
              className="w-full bg-neutral-50 border border-neutral-200 px-4 py-3.5 text-xs text-neutral-900 focus:outline-none focus:border-neutral-900 transition rounded-xl"
              required
            />
          </div>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              <input
                ...
                autoComplete="new-password"
                placeholder="Minimum 6 characters"
                className="w-full bg-neutral-50 border border-neutral-200 px-4 py-3.5 pr-12 text-xs text-neutral-900 focus:outline-none focus:border-neutral-900 transition rounded-xl"
                required
              />
              <button
                type="button"
