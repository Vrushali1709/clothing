...
export default function NewArrivals() {
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen text-neutral-900 py-10 sm:py-14 px-4 sm:px-8 md:px-12 font-sans">
      <div className="max-w-[1440px] mx-auto">
        
        {/* Page Header */}
        <div className="text-center max-w-xl mx-auto mb-10 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl font-serif text-neutral-900 tracking-tight mb-3">
            New Arrivals
          </h1>
          <div className="w-12 h-[1px] bg-[#C8A882] mx-auto"></div>
        </div>

        {/* Grid Display */}
        {loading ? (
          <div className="text-center py-20 font-serif text-neutral-400 text-xs uppercase tracking-widest">
            Curating Latest Pieces...
          </div>
        ) : products.length === 0 ? (
          <div className="text-center py-20 font-serif text-neutral-500 text-sm">
            ...
            {products.map(product => (
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden bg-neutral-100">
                  ...
                  <button 
                    onClick={(e) => handleWishlistToggle(e, product.id)}
                    className="absolute top-3 right-3 p-2.5 bg-white/95 backdrop-blur rounded-full shadow-md hover:scale-110 active:scale-95 transition duration-300 z-20 text-neutral-800"
                    title={wishlistMap[product.id] ? "Remove from Wishlist" : "Add to Wishlist"}
                  >
                    <Heart 
                      size={15} 
                      className={wishlistMap[product.id] ? "fill-red-600 text-red-600" : "text-neutral-700"} 
                    />
                  </button>
