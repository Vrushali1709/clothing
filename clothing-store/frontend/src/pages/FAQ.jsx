    ...
    <div className="bg-[#FAF8F5] min-h-screen text-neutral-900 py-12 px-6 sm:px-8 md:px-12 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center max-w-xl mx-auto mb-14">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif tracking-tight mb-4 text-neutral-900">
            Frequently Asked Questions
          </h1>
          <div className="w-12 h-[1px] bg-[#C8A882] mx-auto mb-4"></div>
          <p className="text-xs sm:text-sm font-light text-neutral-600 leading-relaxed">
            Find answers to common inquiries regarding our shipping policies, garment care, orders, and tailoring services.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div 
              key={index} 
              className="bg-white border border-neutral-200/80 shadow-sm rounded-2xl overflow-hidden transition-all"
            >
              <button
                onClick={() => toggleFAQ(index)}
                className="w-full p-6 text-left flex justify-between items-center gap-4 focus:outline-none group"
              ...
              {openIndex === index && (
                <div className="px-6 pb-6 pt-0 text-xs sm:text-sm text-neutral-600 font-light leading-relaxed border-t border-neutral-100 pt-4">
                  {faq.answer}
                </div>
              )}
            </div>
        ...
        <div className="mt-16 text-center bg-white border border-neutral-200/80 p-8 rounded-2xl shadow-sm">
          ...
          <a 
            href="/contact" 
            className="inline-block bg-neutral-900 text-white px-7 py-3.5 text-xs font-bold uppercase tracking-[0.2em] hover:bg-black transition rounded-xl"
          >
            Contact Concierge
          </a>
        </div>
