...
export default function Cart() {
  ...
  if (cart.length === 0) {
    return (
      <div className="bg-[#FAF8F5] min-h-[80vh] flex flex-col justify-center items-center px-4 py-16 text-center text-neutral-900">
        <div className="w-20 h-20 rounded-full bg-white border border-neutral-200 flex items-center justify-center mb-6 shadow-sm">
          <ShoppingBag
            size={28}
            strokeWidth={1.5}
            className="text-neutral-400"
        ...
        <p className="text-xs sm:text-sm font-light text-neutral-500 max-w-md mb-8 leading-relaxed">
          Discover our curated collection of refined pieces designed to elevate your everyday wardrobe.
        </p>

        <button
          onClick={() => navigate('/shop')}
          className="bg-neutral-900 text-white px-8 py-4 text-xs font-medium uppercase tracking-[0.2em] hover:bg-black transition-all shadow-md flex items-center gap-2 group"
        >
          Explore Collection
          <ArrowRight
            size={14}
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen text-neutral-900 py-10 sm:py-14">
      <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-12 max-w-7xl">
        ...
        {/* HEADER */}
        <div className="mb-8 pb-6 border-b border-neutral-200 flex flex-col sm:flex-row sm:items-end justify-between gap-2">
          <div>
            <h1 className="text-3xl sm:text-4xl font-serif tracking-tight">
              Shopping Bag
            </h1>
        ...
        {/* FREE SHIPPING MESSAGE */}
        <div className="mb-8 bg-white border border-neutral-200 p-5 rounded-xl shadow-sm">
          {amountForFreeShipping > 0 ? (
            <div>
              <div className="flex justify-between items-center gap-4 mb-3">
                <p className="text-xs uppercase tracking-wider text-neutral-600 font-light">
                  Add{' '}
                ...
                <Truck size={18} className="text-neutral-700 shrink-0" />
              </div>
              <div className="h-1.5 bg-neutral-100 rounded-full overflow-hidden">
                <div
                  className="h-full bg-neutral-900 transition-all duration-500"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-4">
            {cart.map((item) => (
              <div
                key={item.cartId}
                className="bg-white border border-neutral-200 p-4 sm:p-6 rounded-xl shadow-sm"
              >
                <div className="flex gap-4 sm:gap-6">
                  {/* IMAGE */}
                  <div className="w-24 h-32 sm:w-28 sm:h-36 bg-neutral-100 shrink-0 overflow-hidden rounded-lg">
                    <img
                      src={getImageUrl(item)}
                      alt={item.name || 'Product'}
                      className="w-full h-full object-cover object-top"
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="mt-2 space-y-0.5 text-xs text-neutral-500">
                        {item.selectedSize && (
                          <p>
                            Size: <span className="text-neutral-800 font-medium">{item.selectedSize}</span>
                          </p>
                        )}
                        {item.selectedColor && (
                          <p>
                            Color: <span className="text-neutral-800 font-medium">{item.selectedColor}</span>
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    {/* PRICE & CONTROLS */}
                    <div className="mt-4 pt-3 border-t border-neutral-100 flex items-center justify-between gap-3">
                      <div className="flex items-center border border-neutral-200 rounded-lg bg-neutral-50 h-10">
                        <button
                          type="button"
                          onClick={() =>
                          ...
                          disabled={item.quantity <= 1}
                          className="w-8 h-full flex items-center justify-center text-neutral-600 hover:text-black disabled:opacity-30"
                        >
                          <Minus size={13} />
                        </button>
                        <span className="w-8 text-center text-xs font-semibold">
                        ...
                        <button
                          ...
                          className="w-8 h-full flex items-center justify-center text-neutral-600 hover:text-black"
                        >
                          <Plus size={13} />
                        </button>
                      </div>
            ...
            <button
              onClick={() => navigate('/shop')}
              className="mt-2 text-xs uppercase tracking-wider font-semibold text-neutral-600 hover:text-black flex items-center gap-2 transition"
            >
          ...
          {/* ORDER SUMMARY */}
          <div className="lg:col-span-5">
            <div className="bg-white border border-neutral-200 p-6 sm:p-8 rounded-xl lg:sticky lg:top-24 shadow-sm">
              <h2 className="font-serif text-xl text-neutral-900 pb-4 border-b border-neutral-200">
                Order Summary
              </h2>

              <div className="space-y-3 mt-5 text-xs text-neutral-600">
              ...
              <div className="mt-6 pt-5 border-t border-neutral-100">
                ...
                {!appliedCoupon ? (
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="ENTER CODE"
                      className="flex-1 bg-neutral-50 border border-neutral-200 px-4 py-3 text-xs uppercase tracking-wider outline-none focus:border-neutral-900 rounded-lg"
                    />
                    <button
                      onClick={handleApplyCoupon}
                      disabled={isApplyingCoupon}
                      className="px-5 bg-neutral-900 text-white text-xs uppercase tracking-wider font-semibold hover:bg-black disabled:opacity-50 transition rounded-lg"
                    >
                      {isApplyingCoupon ? '...' : 'Apply'}
                    </button>
                  </div>
                ) : (
                  <div className="flex items-center justify-between bg-emerald-50 border border-emerald-200 px-4 py-3 rounded-lg">
                    <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={removeCoupon}
                      className="text-xs uppercase tracking-wider text-neutral-500 hover:text-red-600 font-medium"
                    >
                      Remove
                    </button>
                  </div>
                ...
                {couponMessage && appliedCoupon && (
                  <p className="mt-2 text-xs text-emerald-700">{couponMessage}</p>
                )}
                <p className="mt-2 text-[10px] text-neutral-400">
                  Tip: Use promo code WELCOME10 for 10% off.
                </p>
              </div>
              ...
              <button
                onClick={handleCheckout}
                className="w-full mt-6 bg-neutral-900 text-white py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-black transition shadow-md flex items-center justify-center gap-2 rounded-xl group"
              >
                Proceed to Checkout
                <ArrowRight
                  size={15}
              ...
              <div className="flex items-center justify-center gap-2 mt-4 text-[10px] uppercase tracking-wider text-neutral-400">
