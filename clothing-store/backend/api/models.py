...
# # from django.contrib.auth.models import User  # 'models' karvu (s lagavo)
...
# #     sizes = models.CharField(max_length=50, help_text="S, M, L, XL")
# #     colors = models.CharField(max_length=100, help_text="Red, Blue, Black")
...
#     image = models.ImageField(upload_to='products/')
#     sizes = models.CharField(max_length=50, default="S, M, L, XL", help_text="S, M, L, XL")
#     colors = models.CharField(max_length=100, default="Black, White", help_text="Red, Blue, Black")
